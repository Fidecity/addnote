...
func (j *TransferOperation) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	buf.WriteString(`,"from_addr":`)

	{

		obj, err = j.FromAddr.MarshalJSON()
		if err != nil {
			return err
		}
		buf.Write(obj)
	...
	buf.WriteString(`,"to_addr":`)

	{

		obj, err = j.ToAddr.MarshalJSON()
		if err != nil {
			return err
		}
		buf.Write(obj)
...
const (
	...
	ffjtTransferOperationFromAddr

	ffjtTransferOperationToAddr
...
var ffjKeyTransferOperationFromAddr = []byte("from_addr")

var ffjKeyTransferOperationToAddr = []byte("to_addr")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'f':
					...
					} else if bytes.Equal(ffjKeyTransferOperationFromAddr, kn) {
						currentKey = ffjtTransferOperationFromAddr
						state = fflib.FFParse_want_colon
						goto mainparse
				...
				case 't':
					...
					} else if bytes.Equal(ffjKeyTransferOperationToAddr, kn) {
						currentKey = ffjtTransferOperationToAddr
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.AsciiEqualFold(ffjKeyTransferOperationToAddr, kn) {
					currentKey = ffjtTransferOperationToAddr
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyTransferOperationFromAddr, kn) {
					currentKey = ffjtTransferOperationFromAddr
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtTransferOperationFromAddr:
					goto handle_FromAddr

				case ffjtTransferOperationToAddr:
					goto handle_ToAddr
...
handle_FromAddr:
	...
	/* handler: j.FromAddr type=types.Address kind=struct quoted=false*/

	{
		if tok == fflib.FFTok_null {
			...
			err = j.FromAddr.UnmarshalJSON(tbuf)
			if err != nil {
				return fs.WrapErr(err)
			}
		}
...
handle_ToAddr:
	...
	/* handler: j.ToAddr type=types.Address kind=struct quoted=false*/

	{
		if tok == fflib.FFTok_null {
			...
			err = j.ToAddr.UnmarshalJSON(tbuf)
			if err != nil {
				return fs.WrapErr(err)
			}
		}
